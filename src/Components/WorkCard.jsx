...
function WorkCard(props) {
  return (
    <div className="text-white w-[300px] md:w-[700px] lg:w-[1000px] container pt-10 md:pt-12 mx-auto">
      <div>
        <img src={props.image} alt="Image" />
      </div>
      <div className="py-6 w-[300px] md:w-[600px] lg:w-[850px]">
        <p className="text-lg md:text-xl  text-gray">{props.altText}</p>
        <h1 className="font-bold text-2xl md:text-3xl mt-4">{props.title}</h1>
        <p className="text-lg md:text-xl  text-gray mt-4">
          {props.description}
        </p>
